...
describe("Order Creation Payment 3", () => {
  it("Scenario 1: against all outcomes 10.00 @ 2.00", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [10, 0, 0], offset: 0 },
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [10, 10, 0], offset: 10 },
        { len: 1, liquidity: 10, matched: 0 },
        10,
        90,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [10, 10, 10], offset: 20 },
        { len: 1, liquidity: 10, matched: 0 },
        10,
        90,
      ],
  ...
  it("Scenario 2: against all outcomes 10.00 @ 3.00", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [20, 0, 0], offset: 0 },
        { len: 1, liquidity: 10, matched: 0 },
        20,
        80,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [20, 20, 0], offset: 20 },
        { len: 1, liquidity: 10, matched: 0 },
        20,
        80,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [20, 20, 20], offset: 40 },
        { len: 1, liquidity: 10, matched: 0 },
        20,
        80,
      ],
  ...
  it("Scenario 3: against all outcomes 10.00 @ 4.00", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [30, 0, 0], offset: 0 },
        { len: 1, liquidity: 10, matched: 0 },
        30,
        70,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [30, 30, 0], offset: 30 },
        { len: 1, liquidity: 10, matched: 0 },
        30,
        70,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { matched: [0, 0, 0], maxExposure: [30, 30, 30], offset: 60 },
        { len: 1, liquidity: 10, matched: 0 },
        30,
        70,
      ],
