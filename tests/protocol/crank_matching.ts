  ...
  it("all correct - separate purchasers for and against", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { matched: [-2, 10, -2], maxExposure: [0, 0, 0] },
        { matched: [2, -10, 2], maxExposure: [0, 0, 0] },
        { len: 0, liquidity: 0, matched: 2 },
        { len: 0, liquidity: 0, matched: 2 },
        12,
  ...
  it("Consuming liquidity from various pools", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 70, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-60, 120, -60], maxExposure: [80, 0, 80] },
        { matched: [60, -120, 60], maxExposure: [0, 213, 0] },
        473,
        860,
        667,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-100, 200, -100], maxExposure: [40, 0, 40] },
        { matched: [100, -200, 100], maxExposure: [0, 129, 0] },
        469,
        860,
        671,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-130, 263, -130], maxExposure: [10, 0, 10] },
        { matched: [130, -263, 130], maxExposure: [0, 66, 0] },
        469,
        860,
        671,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [-140, 284, -140], maxExposure: [0, 0, 0] },
        { matched: [140, -284, 140], maxExposure: [0, 44, 0] },
        468,
        860,
        672,
      ],
  ...
  it("stake fully matched, remaining against liability refunded", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { matched: [-100, 60, -100], maxExposure: [0, 0, 0] },
        { matched: [100, -60, 100], maxExposure: [0, 0, 0] },
        160,
        0,
        40,
  ...
  it("usecase B10@4_W1 L5@4_W2 L10@4_W2", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [-10, 30, -10], maxExposure: [0, 0, 0] },
        { matched: [10, -30, 10], maxExposure: [0, 15, 0] },
        55,
        90,
        55,
      ],
  ...
  it("usecase B10@4_W1 L5@4_W2 L10@4_W1", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [5, -15, 5], maxExposure: [0, 0, 0] },
        30,
        85,
        85,
      ],
...
async function setupMatchedOrders(
  ...
  assert.deepEqual(
    ...
    [
      { stakeUnmatched: stake, stakeVoided: 0, status: { open: {} } },
      { stakeUnmatched: stake, stakeVoided: 0, status: { open: {} } },
      { matched: [0, 0, 0], maxExposure: [stake, stake * (price - 1), stake] },
