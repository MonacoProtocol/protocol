  ...
  it("all correct - same purchaser for and against", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { matched: [0, 0, 0], maxExposure: [2, 10, 2], offset: 2 },
  ...
  it("all correct - separate purchasers for and against", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 2, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [2, 0, 2], offset: 0 },
        { matched: [0, 0, 0], maxExposure: [0, 10, 0], offset: 0 },
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { matched: [-2, 10, -2], maxExposure: [2, 0, 2], offset: 0 },
        { matched: [2, -10, 2], maxExposure: [0, 10, 0], offset: 0 },
        { len: 0, liquidity: 0, matched: 2 },
        { len: 0, liquidity: 0, matched: 2 },
        12,
      ],
  ...
  it("two for orders", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 2, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 2, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [4, 10, 4], offset: 4 },
  ...
  it("two against orders", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 2, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 2, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [2, 20, 2], offset: 2 },
        { len: 1, liquidity: 2, matched: 0 },
        { len: 2, liquidity: 4, matched: 0 },
        20,
      ],
  ...
  it("Consuming liquidity from various pools", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [0, 0, 0], maxExposure: [140, 0, 140], offset: 0 },
        { matched: [0, 0, 0], maxExposure: [0, 339, 0], offset: 0 },
        479,
        860,
        661,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 70, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-60, 120, -60], maxExposure: [140, 0, 140], offset: 0 },
        { matched: [60, -120, 60], maxExposure: [0, 333, 0], offset: 0 },
        473,
        860,
        667,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-100, 200, -100], maxExposure: [140, 0, 140], offset: 0 },
        { matched: [100, -200, 100], maxExposure: [0, 329, 0], offset: 0 },
        469,
        860,
        671,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 30, stakeVoided: 0, status: { open: {} } },
        { matched: [-130, 263, -130], maxExposure: [140, 0, 140], offset: 0 },
        { matched: [130, -263, 130], maxExposure: [0, 329, 0], offset: 0 },
        469,
        860,
        671,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [-140, 284, -140], maxExposure: [140, 0, 140], offset: 0 },
        { matched: [140, -284, 140], maxExposure: [0, 328, 0], offset: 0 },
        468,
        860,
        672,
      ],
  ...
  it("stake fully matched, remaining against liability refunded", async () => {
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 100, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 100, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [100, 0, 100], offset: 0 },
        { matched: [0, 0, 0], maxExposure: [0, 70, 0], offset: 0 },
        170,
        0,
        30,
      ],
    ...
    assert.deepEqual(
      ...
      [
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { matched: [-100, 60, -100], maxExposure: [100, 0, 100], offset: 0 },
        { matched: [100, -60, 100], maxExposure: [0, 60, 0], offset: 0 },
        160,
        0,
        40,
      ],
  ...
  it("usecase B10@4_W1 L5@4_W2 L10@4_W2", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [0, 0, 0], maxExposure: [0, 45, 0], offset: 0 },
        55,
        90,
        55,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { matched: [-10, 30, -10], maxExposure: [10, 0, 10], offset: 0 },
        { matched: [10, -30, 10], maxExposure: [0, 45, 0], offset: 0 },
        55,
        90,
        55,
      ],
  ...
  it("usecase B10@4_W1 L5@4_W2 L10@4_W1", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 5, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 10, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [10, 30, 10], offset: 10 },
        { matched: [0, 0, 0], maxExposure: [0, 15, 0], offset: 0 },
        45,
        70,
        85,
      ],
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 0, stakeVoided: 0, status: { matched: {} } },
        { stakeUnmatched: 5, stakeVoided: 0, status: { matched: {} } },
        { matched: [-5, 15, -5], maxExposure: [10, 30, 10], offset: 10 },
        { matched: [5, -15, 5], maxExposure: [0, 15, 0], offset: 0 },
        45,
        70,
        85,
      ],
  ...
  it("usecase B10@4_W1 L5@4_W1 L10@4_W1", async () => {
    ...
    assert.deepEqual(
      ...
      [
        ...
        { stakeUnmatched: 5, stakeVoided: 0, status: { open: {} } },
        { stakeUnmatched: 10, stakeVoided: 0, status: { open: {} } },
        { matched: [0, 0, 0], maxExposure: [10, 45, 10], offset: 10 },
        45,
        55,
        100,
      ],
